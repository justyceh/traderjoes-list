...
const filePath = path.join(__dirname, 'beverages-products.json');
...
const scrapeAllFoodProducts = async () => {
  ...
  await page.goto('https://www.traderjoes.com/home/products/category/beverages-182', {
    waitUntil: 'networkidle2'
  });

  const allProducts = new Map(); // Use Map to prevent duplicates
  const MAX_PRODUCTS = 234; // Adjust as needed
  let pageIndex = 1;
...
// This is the final correct version of the website scraper to get all of the beverage items
